...
bool
NavigateToTopologyNavigator::configure(
  ...
  std::shared_ptr<nav2_util::OdomSmoother> odom_smoother)
{
  ...
  goal_sub_ = node->create_subscription<geometry_msgs::msg::PoseStamped>(
    ...
    std::bind(&NavigateToTopologyNavigator::onGoalPoseReceived, this, std::placeholders::_1));
  return true;
}

std::string
NavigateToTopologyNavigator::getDefaultBTFilepath(
  rclcpp_lifecycle::LifecycleNode::WeakPtr parent_node)
{
...
bool
NavigateToTopologyNavigator::cleanup()
{
  goal_sub_.reset();
  self_client_.reset();
  return true;
...
bool
NavigateToTopologyNavigator::goalReceived(ActionT::Goal::ConstSharedPtr goal)
{
...
void
NavigateToTopologyNavigator::goalCompleted(
...
void
NavigateToTopologyNavigator::onLoop()
{
...
void
NavigateToTopologyNavigator::onPreempt(ActionT::Goal::ConstSharedPtr goal)
{
...
void
NavigateToTopologyNavigator::initializeGoalPose(ActionT::Goal::ConstSharedPtr goal)
{
  geometry_msgs::msg::PoseStamped current_pose;
  nav2_util::getCurrentPose(
    current_pose, *feedback_utils_.tf,
...
void
NavigateToTopologyNavigator::onGoalPoseReceived(const geometry_msgs::msg::PoseStamped::SharedPtr pose)
{
  ActionT::Goal goal;
  goal.pose = *pose;
