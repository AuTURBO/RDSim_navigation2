...
ComputePathToTopologyAction::ComputePathToTopologyAction(
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<nav2_behavior_tree::ComputePathToTopologyAction>(
        name, "compute_path_to_topology", config);
    };

  factory.registerBuilder<nav2_behavior_tree::ComputePathToTopologyAction>(
    "ComputePathToTopology", builder);
}
